    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            @if($kelas)
                <div class="mt-6 p-4 bg-blue-50 rounded-lg">
                    <h2 class="text-sm font-semibold text-gray-900 mb-2">Informasi Asrama</h2>
        ...
        @else
            <div class="bg-white rounded-lg shadow-sm p-12 text-center">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">Pilih Asrama dan Semester</h3>
                <p class="mt-1 text-sm text-gray-500">Silakan pilih asrama dan semester untuk melihat leger asrama.</p>
            </div>
        @endif
    </div>
</div>
