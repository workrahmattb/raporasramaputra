<div>
    ...
    <div class="mb-6 bg-white rounded-lg shadow-md p-4">
        <div class="relative">
            <input wire:model.live="search" type="text" placeholder="Cari nama mata pelajaran..." 
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($mataPelajarans as $mataPelajaran)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-600 max-w-xs truncate">{{ $mataPelajaran->deskripsi ?? '-' }}</div>
                        </td>
