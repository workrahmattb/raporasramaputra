<div>
    ...
    <div class="mb-6 bg-white rounded-lg shadow-md p-4">
        <div class="flex items-center gap-4">
            <label class="text-sm font-medium text-gray-700 whitespace-nowrap">Pilih Mata Pelajaran:</label>
            <select wire:model.live="mataPelajaranId" id="mataPelajaran" 
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-32">Nilai</th>
                                </tr>
                            </thead>
    ...
    @elseif(!$mataPelajaranId)
        <div class="bg-white rounded-lg shadow-md p-12 text-center text-gray-500">
            ...
            <p class="mt-4 text-lg">Silakan pilih mata pelajaran untuk mulai input nilai</p>
        </div>
    @endif
</div>
